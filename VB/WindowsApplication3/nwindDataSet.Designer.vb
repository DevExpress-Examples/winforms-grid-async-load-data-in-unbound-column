...
Namespace DXSample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class OrdersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddOrdersRow(ByVal CustomerID As String, ByVal EmployeeID As Integer, ByVal Freight As Decimal, ByVal ShipName As String) As OrdersRow
				Dim rowOrdersRow As OrdersRow = (CType(Me.NewRow(), OrdersRow))
				Dim columnValuesArray() As Object = { Nothing, CustomerID, EmployeeID, Freight, ShipName}
...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Orders` WHERE ((`OrderID` = ?) AND ((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)) AND ((? = 1 AND `EmployeeID` IS NULL) OR (`EmployeeID` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)) AND ((? = 1 AND `ShipName` IS NULL) OR (`ShipName` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`CustomerID`, `EmployeeID`, `Freight`, `ShipName`) VALUES (" & "?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `CustomerID` = ?, `EmployeeID` = ?, `Freight` = ?, `ShipName` = ? WHERE ((`OrderID` = ?) AND ((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)) AND ((? = 1 AND `EmployeeID` IS NULL) OR (`EmployeeID` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)) AND ((? = 1 AND `ShipName` IS NULL) OR (`ShipName` = ?)))"
		...
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_EmployeeID As Global.System.Nullable(Of Integer), ByVal Original_Freight As Global.System.Nullable(Of Decimal), ByVal Original_ShipName As String) As Integer
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CStr(Original_ShipName))
			End If
		...
		Public Overridable Function Insert(ByVal CustomerID As String, ByVal EmployeeID As Global.System.Nullable(Of Integer), ByVal Freight As Global.System.Nullable(Of Decimal), ByVal ShipName As String) As Integer
			...
			Else
				Me.Adapter.InsertCommand.Parameters(3).Value = (CStr(ShipName))
			End If
		...
		Public Overridable Function Update(ByVal CustomerID As String, ByVal EmployeeID As Global.System.Nullable(Of Integer), ByVal Freight As Global.System.Nullable(Of Decimal), ByVal ShipName As String, ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_EmployeeID As Global.System.Nullable(Of Integer), ByVal Original_Freight As Global.System.Nullable(Of Decimal), ByVal Original_ShipName As String) As Integer
			If (CustomerID Is Nothing) Then
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CStr(ShipName))
			End If
			...
			If (Original_EmployeeID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CInt(Fix(Original_EmployeeID.Value)))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CStr(Original_ShipName))
			End If
