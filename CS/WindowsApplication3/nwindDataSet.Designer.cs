...
namespace DXSample {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OrdersRow AddOrdersRow(string CustomerID, int EmployeeID, decimal Freight, string ShipName) {
...
namespace DXSample.nwindDataSetTableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Orders` WHERE ((`OrderID` = ?) AND ((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)) AND ((? = 1 AND `EmployeeID` IS NULL) OR (`EmployeeID` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)) AND ((? = 1 AND `ShipName` IS NULL) OR (`ShipName` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`CustomerID`, `EmployeeID`, `Freight`, `ShipName`) VALUES (" +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Orders` SET `CustomerID` = ?, `EmployeeID` = ?, `Freight` = ?, `ShipName` = ? WHERE ((`OrderID` = ?) AND ((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)) AND ((? = 1 AND `EmployeeID` IS NULL) OR (`EmployeeID` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)) AND ((? = 1 AND `ShipName` IS NULL) OR (`ShipName` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT OrderID, CustomerID, EmployeeID, Freight, ShipName FROM Orders";
        ...
        public virtual int Delete(int Original_OrderID, string Original_CustomerID, global::System.Nullable<int> Original_EmployeeID, global::System.Nullable<decimal> Original_Freight, string Original_ShipName) {
        ...
        public virtual int Insert(string CustomerID, global::System.Nullable<int> EmployeeID, global::System.Nullable<decimal> Freight, string ShipName) {
            if ((CustomerID == null)) {
            ...
            if ((ShipName == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(ShipName));
            }
        ...
        public virtual int Update(string CustomerID, global::System.Nullable<int> EmployeeID, global::System.Nullable<decimal> Freight, string ShipName, int Original_OrderID, string Original_CustomerID, global::System.Nullable<int> Original_EmployeeID, global::System.Nullable<decimal> Original_Freight, string Original_ShipName) {
            if ((CustomerID == null)) {
            ...
            if ((ShipName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(ShipName));
            }
            ...
            if ((Original_Freight.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((decimal)(Original_Freight.Value));
            }
            else {
            ...
            if ((Original_ShipName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_ShipName));
            }
